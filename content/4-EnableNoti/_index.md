...
{{% notice note%}}
To do this step, you need to have **AWS CLI** installed on your machine. Please refer to this [000011 - Use AWS CLI on Windows/Ubuntu](https://000011.awsstudygroup.com/) for installation instructions.
{{% /notice%}}
